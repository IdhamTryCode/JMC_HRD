...
type EmpDetail = {
  ...
  birth_kabupaten_name: string | null; birth_provinsi_name: string | null;
          ...
          <Card elevation={0} variant="outlined" sx={{ borderRadius: 3 }}>
            <CardContent>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={6}><Field label="Tempat Lahir" value={emp.birth_kabupaten_name ? `${emp.birth_kabupaten_name}${emp.birth_provinsi_name ? `, ${emp.birth_provinsi_name}` : ""}` : null} /></Grid>
        ...
        <Grid item xs={12} md={6}>
          <Card elevation={0} variant="outlined" sx={{ borderRadius: 3 }}>
            <CardContent>
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}><Field label="Tanggal Masuk" value={emp.join_date} /></Grid>
                <Grid item xs={6}><Field label="Masa Kerja" value={`${emp.masa_kerja_tahun} tahun`} /></Grid>
                <Grid item xs={6}><Field label="Usia" value={`${emp.masa_kerja_tahun} tahun`} /></Grid>
