...
export default function LogsPage() {
  ...
  const columns: GridColDef[] = [
    {
      field: "created_at", headerName: "Waktu", width: 160,
      renderCell: ({ value }) => dayjs(value).format("DD/MM/YY HH:mm:ss"),
    },
    {
    ...
    {
      field: "module", headerName: "Modul", width: 110,
      renderCell: ({ value }) => <Chip label={value} size="small" variant="outlined" />,
    },
    { field: "action", headerName: "Aksi", width: 150 },
    {
      field: "description", headerName: "Deskripsi", flex: 1, minWidth: 200,
      renderCell: ({ value }) => value ?? "—",
    },
    { field: "ip_address", headerName: "IP", width: 120, renderCell: ({ value }) => value ?? "—" },
  ];
