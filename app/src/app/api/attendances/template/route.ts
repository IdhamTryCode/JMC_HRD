...
export async function GET(req: NextRequest) {
  ...
  // Contoh data
  ws.addRow({ nip: "12345678", tanggal: "2025-01-02", jam_masuk: "08:00", jam_keluar: "17:00", status: "hadir", keterangan: "" });
  ws.addRow({ nip: "12345678", tanggal: "2025-01-03", jam_masuk: "", jam_keluar: "", status: "cuti", keterangan: "Cuti tahunan" });
  ...
  ws.addRow(["- Jam Masuk dan Jam Keluar wajib diisi jika status = hadir"]);
